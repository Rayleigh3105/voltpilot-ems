...
CREATE TABLE IF NOT EXISTS schedule (
    ...
    why_terminal_anchor TEXT,                   -- run: which branch anchored the stored-energy value (V20260822000000)
    why_refill_free_pct NUMERIC(5, 1),          -- run: free PV refill share of the usable band, 0-100 (V20260822000000)
    why_next_best     TEXT,                     -- resting slot: the best REJECTED action (V20260822000000)
    why_next_best_margin_ct NUMERIC(12, 4),     -- its disadvantage in ct/kWh, <= 0 (V20260822000000)
