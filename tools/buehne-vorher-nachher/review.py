...
def main() -> None:
    ...
    for breite in (375, 1440):
        ...
        abschnitte.append(paar(
            ...
            "Befund: Die gebaute Oberfläche lässt nur alle drei getrennt oder alle zusammen; die verlangte Gruppierung 2 + 1 ist nicht bedienbar. Der gezeigte echte Standardweg erzeugt deshalb drei statt zwei Standorte.",
        ))
