...
| Datei | Inhalt |
|---|---|
| [`glossar.md`](glossar.md) | Die Begriffs-Einträge — 23 aus AP-00 §4.1 und die Nachträge späterer Pakete (Stand 24.09.2026: 66 Einträge; die aktuelle Zahl nennt der Kopf der erzeugten Datei): Definition · Erläuterung · Beispiel aus dem Referenzunternehmen · „Heute im Code“ mit Belegen `datei:zeile` · Abgrenzung zu den Nachbarbegriffen. |
