...
GLOSSAR += [
    ...
    {"id": "bericht", "sicht": "org", "begriff": "Bericht", "nachtrag": "AP-12 §4.1 (E1, E8, E9)",
     ...
     "heute": "Heute nicht vorhanden; es gibt nur den Geräte-Export ohne Stand. Die Regeln stehen als Vertrag in `docs/contracts/v2/bericht.md` samt Vektoren (`bericht-vectors.json`, Zwillinge `uems/BerichtRegeln` ⟷ `uemsBericht.ts`, AP-12 IP-1/IP-3); Tabellen, Routen und Fläche kommen mit AP-12 IP-4 ff.",
    ...
    {"id": "berichtsvorlage", "sicht": "org", "begriff": "Berichtsvorlage", "nachtrag": "AP-12 §4.5 (E9)",
     ...
     "heute": "Heute nicht vorhanden. Der Katalog steht in `docs/contracts/v2/bericht-vorlagen.json` (vier Vorlagen, AP-12 IP-1); ausgeliefert wird er ab AP-12 IP-5.",
    ...
    {"id": "berichtsstand", "sicht": "org", "begriff": "Berichtsstand", "nachtrag": "AP-12 §4.3 (E1, E2, E5)",
     ...
     "heute": "Heute nicht vorhanden. Die Form steht in `docs/contracts/v2/bericht.schema.json` (Abzug, Stand); die Tabelle kommt mit AP-12 IP-4.",
    ...
    {"id": "revision", "sicht": "org", "begriff": "Revision", "nachtrag": "AP-12 §4.9 (E6, E7)",
     ...
     "heute": "Heute nicht vorhanden. Die Regeln stehen in `docs/contracts/v2/bericht.md` (Betroffenheit, Anstoß, Abweichung); Anstoß-Tabelle und Kaskaden-Naht kommen mit AP-12 IP-4/IP-8.",
    ...
    {"id": "datenstand", "sicht": "org", "begriff": "Datenstand", "nachtrag": "AP-12 §4.6 (E4)",
     ...
     "heute": "Für Berichte heute nicht vorhanden. Die Regeln stehen in `docs/contracts/v2/bericht.md` (Datenstand, D1–D5, AP-12 IP-1/IP-3).",
    ...
    {"id": "quellenverzeichnis", "sicht": "org", "begriff": "Quellenverzeichnis", "nachtrag": "AP-12 §4.4 (E3, E6)",
     ...
     "heute": "Heute nicht vorhanden. Die Form einer Zeile steht in `docs/contracts/v2/bericht.schema.json` (Quelle); die Tabelle kommt mit AP-12 IP-4.",
