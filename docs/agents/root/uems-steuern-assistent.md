# Assistent „Steuern & Optimieren“ — Schritte 1–6
...
`SteuernAssistent.test.tsx` spielt Referenzfall 5 bis Schritt 6 und belegt: rote Zeile → kein Start-Knopf. `FunktionApiTest` prüft Fakt/Grund/Weg, Fremd-404, A3 sowie den vollständigen Rollback eines erzwungen fehlgeschlagenen Starts. `e2e/steuern-assistent.spec.ts` durchläuft alle sechs Schritte je zweimal bei 375 und 1440 px und prüft Querlauf.
