...
**Nicht gebaut:** der Schreib-Teil im Portal (anlegen, umbenennen, beenden) und die Durchsetzung (AP-03). Die Verteilung
steht seit IP-8 (`uems-verteilung.md`), die Kostenstellen-Sicht seit IP-11 (`uems-kostenstelle-energie.md`), die LESENDE
Fläche mit beiden Katalogen seit AP-13 IP-9 (`uems-kostenstellen-flaeche.md`).
