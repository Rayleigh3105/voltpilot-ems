...
- **Die API speichert `art` additiv.** Der Dialog schreibt die gewählte Art; die Liste zeigt nur
  die gespeicherte Art, sonst „Art nicht angegeben“. Die übrigen Felder erlauben keine
  eindeutige Rekonstruktion. Bestand, Prüfung und Leser: [Art als Datum](uems-bezugsgroesse-art.md).
