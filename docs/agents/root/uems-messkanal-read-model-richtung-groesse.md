...
- **Zwei Katalog-Stände.** `VERSION` (Inhaltsstand, 2026.09.11.1) ≠ `RUNTIME_VERSION`
  (Laufzeitstand der Box, bis 23.09.2026 2026.08.26.3, seither 2026.09.23.2, mit AP-05 IP-6b 2026.09.23.3). Die Palette lehnt jede Mess-Konfiguration mit fremder
