...
| [`verbesserung.md`](./verbesserung.md) + [`verbesserung-vectors.json`](./verbesserung-vectors.json) + [`verbesserung.schema.json`](./verbesserung.schema.json) | Regeln und gemeinsame Testvektoren für Energieziele, Maßnahmen und Abweichungen (AP-18): Wirkung Σ ÷ Σ über die Nachher-Monate, Ziel-Stand mit Vorschlag, Frist, Kundensätze. |
