...
| Energieeinsatz einstufen | AP-16 §6.1 (B1/B4, R14) | U | U | - | - | - | - | - | Reserviert für AP-16 IP-4 (Routen); Zuständigkeit verleiht kein Recht. Einstufung erst mit IP-11/IP-12. |
...
| AP-16 §6.1 | Energieeinsatz einstufen | KA U · EM U | `energieeinsatz.einstufen` | `energieeinsatz.einstufen` | neue Zeile | Reserviert für AP-16 IP-4 (Routen); Zuständigkeit verleiht kein Recht. Einstufung erst mit IP-11/IP-12. |
