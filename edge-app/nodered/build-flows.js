...
const controlRouteSource = [
  ...
  "      if (!(rRated > 0)) { rBase.writes = []; rBase.readbacks = []; rBase.planned = []; rBase.reason = 'Fernsteuerung: Nennleistung des Modells unbekannt - bitte das genaue Wechselrichter-Modell ausw\\u00e4hlen (der Sollwert ist 0,1 % der Nennleistung).'; return rBase; }",
  ...
  "      return deyeFinalize([], { powerScaleConfirmed: false, powerScaleSource: powerScaleSource, powerScaleSuppressed: true, reason: 'Leistungsskalierung unbest\\u00e4tigt (HV/LV): Der Schreibplan wird zur\\u00fcckgehalten, damit ein HV-Wechselrichter nicht 10-fach \\u00fcberschrieben wird. Bitte die Leistungsskalierung am Wechselrichter setzen (HV = 10, LV = 1) oder das Ger\\u00e4t erreichbar machen, damit sie automatisch erkannt wird.' });",
  "    }",
  "    var slot = 0;",
...
const controlExecSolarmanFunc = [
  ...
  "  toWrite.push(w);",
  "}",
  "// Nothing to do at all: no readback surface AND no capability probe due.",
