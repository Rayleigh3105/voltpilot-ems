...
const controlRouteSource = [
  ...
  "      var out = { adapter: 'solarman_v5', family: family, controlPath: 'tou', target: ip + ':' + dport, connection: { ip: ip, port: dport, serial: serial, mb_slave_id: slaveId }, certified: certified, controlEnabled: controlEnabled, calibration: calibration === true, writes: dWriteAllowed ? execWrites : [], readbacks: dWriteAllowed ? readbacks : [], planned: planned, capabilityProbe: capabilityProbe };",
...
const controlReleaseSource = [
  ...
  "      return { adapter: 'solarman_v5', family: family, tier: tier, certified: certified, calibration: calibration, mode: 'release', controlPath: 'remote', target: ip + ':' + dport, connection: { ip: ip, port: dport, serial: serial, mb_slave_id: slaveId }, writes: releaseAllowed ? rpl : [], readbacks: releaseAllowed ? rrb : [], planned: rpl, capabilityProbe: capabilityProbe, reason: releaseAllowed ? undefined : 'Steuerung f\\u00fcr dieses Modell noch nicht freigegeben' };",
  "    }",
  "    var dplanned = [];",
  ...
  "    return { adapter: 'solarman_v5', family: family, tier: tier, certified: certified, calibration: calibration, mode: 'release', controlPath: 'tou', target: ip + ':' + dport, connection: { ip: ip, port: dport, serial: serial, mb_slave_id: slaveId }, writes: releaseAllowed ? dplanned : [], readbacks: releaseAllowed ? drb : [], planned: dplanned, capabilityProbe: capabilityProbe, reason: releaseAllowed ? undefined : 'Steuerung f\\u00fcr dieses Modell noch nicht freigegeben' };",
  "  }",
  "  if (tier === 2) {",
  "    var v2port = Number(conn.port) > 0 ? Number(conn.port) : 502;",
