...
const controlReleaseSource = [
  ...
  "    var slaveId = Number(conn.mb_slave_id) > 0 ? Number(conn.mb_slave_id) : 1;",
  "    var reg = Object.prototype.hasOwnProperty.call(DEYE_REG, family) ? DEYE_REG[family] : null;",
  "    var dplanned = reg ? [{ role: 'tou_enable', fc: 6, addr: reg.touEnable, value: 0, encode: { kind: 'tou_mask', all_week: false, release: true }, dwell_s: calibration ? 0 : 900, min_change: 0, bench_pending: true }] : [];",
