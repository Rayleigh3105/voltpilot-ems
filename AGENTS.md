...
- `openapi.yaml` - portal API. The auth/sites/devices/telemetry/prices/weather/schedule and claim endpoints are **implemented** in `services/api`; KPIs are still a stub. Keep this file in sync when changing those endpoints.
