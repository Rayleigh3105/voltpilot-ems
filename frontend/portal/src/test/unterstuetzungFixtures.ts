...
export function anfrageFixture(): UnterstuetzungAnfrage {
  return { id: '22222222-2222-4222-8222-222222222222', art: 'voltpilot', umfang: 'ansehen', standorte: [STANDORT_IDS['ST-1']],
    angefragt_von: { kennung: 'LV', name: 'Lena Voss' }, gueltig_ab: '2026-10-20T08:00:00Z', gueltig_bis: '2026-10-28', grund: 'Verbindung prüfen', zustand: 'offen', entschieden_am: null, unterstuetzung: null, angefragt_am: '2026-10-20T08:00:00Z' };
}
export function notfallFixture(): Unterstuetzung {
  return { ...unterstuetzungFixture(), id: '33333333-3333-4333-8333-333333333333', art: 'notfall',
    unterstuetzer: { kennung: 'LV', name: 'Lena Voss' }, gueltig_bis: null, endet: '2026-10-21T08:00:00Z',
