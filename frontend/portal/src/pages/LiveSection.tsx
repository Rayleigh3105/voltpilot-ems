 ...
 * verdict tiles, energy-flow diagram and the Verlauf chart with its window
 * toggle. The Anlagen-Seite links here ("Live-Daten im Detail"); the page
 * itself keeps only the compact energy-flow snapshot.
 */
