...
const FAELLE: Fall[] = [
  ...
  },
  {
    ...
    route: `#/standort/${ST1}`,
    sichtbar: [
      '2 von 2 Anlagen liefern Daten',
      '408,9',
      'Läuft mit Werk Ahrenberg – Halle 1',
      'Halle 1 ← System Halle 1 (NA-1)',
      'Halle 2 ← System Halle 2 (NA-2)',
      '1 Messstelle außerhalb eines Gebäudes',
    ],
    gruppen: 0,
  },
  {
    ...
    route: `#/standort/${ST2}`,
    sichtbar: ['1 von 1 Anlage liefert Daten', '38,7', '3 von 3 Messstellen liefern Daten', 'Lager · nicht messbar'],
    ohneSteuern: true,
    gruppen: 0,
  },
];
